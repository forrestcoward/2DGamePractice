...
public:
	...
	static Creature* Texture::createLevelObjects(vector<SDL_Rect>* clips, string fileName, SDL_Texture* spriteSheet, vector <Texture>* mapTerrain, SDL_Texture* backgroundTexture, SDL_Renderer* renderer);
	static void Texture::renderAllTextures(SDL_Rect* camera, SDL_Texture* backgroundTexture, Creature* mario, vector <Texture>* mapTerrain, SDL_Renderer* renderer);
